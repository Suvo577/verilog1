...
HD_PWD='C:/M.TECH IITP/verilog/swaping/swaping.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log swap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source swap.tcl -notrace
