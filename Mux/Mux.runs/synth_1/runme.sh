...
HD_PWD='C:/M.TECH IITP/Mux/Mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cond_op_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cond_op_mux.tcl
